/* 
---Module 1:SQL operators
    Module 1.1:SQL Arithmetic operators
						+	Add	
						-	Subtract	
						*	Multiply	
						/	Divide	
...
/*---Module 1.2:SQL Comparison Operators 
						=	Equal to	
						>	Greater than	
						<	Less than	
...
/*---Module 1.3:SQL Compound Operators 
						+=	Add equals
						-=	Subtract equals
						*=	Multiply equals
						/=	Divide equals
...
/*
*---Module 1.4:SQL Logical Operators
...
Part 2: SQL FUNCTIONS
        ...
        2.3:SQL Server Math/Numeric Functions
        2.4:JSON functions (Transact-SQL)
        2.5:Conversion Functions (Transact-SQL)
